...
class JobScrape:
  ...
  def __init__(self, site_name):
    ...
    try:
        self.site_data = [site[site_name] for site in sites if site_name in site]
        [0]
        self.site_name = site_name
       
    except IndexError:
      raise ValueError(f"{site_name} is not found or supported yet")
  ...
  def get_jobs(self, city,country,keywords, desc=True):
    """Method of the class. Calls the scraper and formats
    the results based on which site was selected"""
